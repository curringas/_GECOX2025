...
<div class="mb-4 position-relative shadow-sm p-1" data-id="<?php echo e($clase->Identificador); ?>">
            ...
            <div class="overflow-hidden" style="background: url('<?php echo e($img->thumb_url); ?>') center center / cover no-repeat; min-height: 280px;">
                ...
                <div class="d-flex flex-column justify-content-end h-100 w-100" style="background: rgba(255,255,255,0.0);">
                    <div class="p-3 text-primary" style="background: rgba(255,255,255,0.7); border-radius: 0 0 12px 12px;">
                        <h5 class="text-primary mb-1"><?php echo e($clase?->publicacion->Titulo ?? 'Título de la noticia'); ?></h5>
                        <p class="mb-0"><?php echo e($clase?->publicacion?->Fecha->format('d/m/Y')); ?> | <?php echo e($clase?->publicacion?->Autor); ?></p>
                    </div>
                </div>
            </div>
        <?php else: ?>
    ...
    <?php elseif($clase->BannerImagen): ?>
        <img src="<?php echo e(asset('storage/'.$clase->BannerImagen)); ?>" 
            ...
            class="img-fluid">
    <?php endif; ?>
</div><?php /**PATH /Users/curro/Developer/_GECOX2025/resources/views/portada/item.blade.php ENDPATH**/ ?>
...
<!-- App js -->
<script src="<?php echo e(asset('build/js/plugin.js')); ?>"></script><?php /**PATH C:\PROYECTOS\_SKOTE-LARAVEL-template\Starterkit\resources\views/layouts/head-css.blade.php ENDPATH**/ ?>
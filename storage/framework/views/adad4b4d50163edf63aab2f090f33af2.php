...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name', $user?->name)); ?>" id="name" placeholder="<?php echo app('translator')->get("translation.Nombre"); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email', $user?->email)); ?>" id="email" placeholder="Email" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">    
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="newpassword" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="newpassword" placeholder="" value="<?php echo e(old('newpassword', $user?->password)); ?>">
                            ...
                            <div class="col-md-6">    
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="newpassword_confirmation" class="form-control <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="newpassword_confirmation" placeholder="" value="<?php echo e(old('newpassword_confirmation', $user?->password)); ?>">
                                    <?php echo $errors->first('newpassword_confirmation', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>'); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="duedate-input" class="form-control" placeholder="Select due date" name="dob" data-date-format="dd M, yyyy" data-provide="datepicker" data-date-autoclose="true" value="<?php echo e(old('dob',$user->dob ?? \Carbon\Carbon::now()->format('Y-m-d'))); ?>">
                        ...
                        <div class="text-center">
                            <div class="position-relative d-inline-block">
                                <div class="position-absolute bottom-0 end-0">
                                    ...
                                    <input name="avatar" class="form-control d-none" id="project-image-input" type="file" accept="image/png, image/gif, image/jpeg">
                                </div>
                                <div class="avatar-lg">
                        ...
                        <div class="mb-3">
                            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check form-switch form-switch-md mb-3" dir="ltr">
                                    <input class="form-check-input" type="checkbox" id="permiso<?php echo e($permission->id); ?>" name="permissions[]" value="<?php echo e($permission->name); ?>" <?php echo e($user->hasPermissionTo($permission->name) ? 'checked' : ''); ?>>
...
</div><?php /**PATH C:\PROYECTOS\_SKOTE-LARAVEL-template\started-kit-te20\resources\views/users/form.blade.php ENDPATH**/ ?>
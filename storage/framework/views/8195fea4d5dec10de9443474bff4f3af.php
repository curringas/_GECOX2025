                ...
                <tr>
                    ...
                    <td>
                        <form action="<?php echo e(route('roles.destroy', $role->id)); ?>" method="POST">
                            <a class="btn btn-sm btn-primary " href="<?php echo e(route('roles.show', $role->id)); ?>"><i class="fa fa-fw fa-eye"></i> <?php echo e(__('Ver')); ?></a>
                            <a class="btn btn-sm btn-success" href="<?php echo e(route('roles.edit', $role->id)); ?>"><i class="fa fa-fw fa-edit"></i> <?php echo e(__('Editar')); ?></a>
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/curro/Documents/WEBSERVICES/_GECOX2025/resources/views/roles/index.blade.php ENDPATH**/ ?>